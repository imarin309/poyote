...
// Canvasの実処理はjsdomで動かせないので、変換とダウンロードは差し替えて配線だけ見る
vi.mock('../services/convertImage', () => ({
  convertImageToBlob: vi.fn(
